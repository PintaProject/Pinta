...
partial class UserBlendOps
{
	...
	public sealed class OverlayBlendOp : UserBlendOp
	{
		...
		private sealed class OverlayBlendOpWithOpacity : UserBlendOp
		{
			...
			public OverlayBlendOpWithOpacity (int opacity) { if (this.opacity < 0 || this.opacity > 255) { throw new ArgumentOutOfRangeException (nameof (opacity)); } this.opacity = opacity; }
		}
	}
}
