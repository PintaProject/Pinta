...
partial class UserBlendOps
{
	...
	public sealed class NegationBlendOp : UserBlendOp
	{
		...
		private sealed class NegationBlendOpWithOpacity : UserBlendOp
		{
			...
			public NegationBlendOpWithOpacity (int opacity) { if (this.opacity < 0 || this.opacity > 255) { throw new ArgumentOutOfRangeException (nameof (opacity)); } this.opacity = opacity; }
		}
	}
}
