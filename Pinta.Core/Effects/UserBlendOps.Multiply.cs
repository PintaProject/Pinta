...
partial class UserBlendOps
{
	...
	public sealed class MultiplyBlendOp : UserBlendOp
	{
		...
		private sealed class MultiplyBlendOpWithOpacity : UserBlendOp
		{
			...
			public MultiplyBlendOpWithOpacity (int opacity) { if (this.opacity < 0 || this.opacity > 255) { throw new ArgumentOutOfRangeException (nameof (opacity)); } this.opacity = opacity; }
		}
	}
}
