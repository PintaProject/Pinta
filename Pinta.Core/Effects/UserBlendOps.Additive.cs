...
partial class UserBlendOps
{
	...
	public sealed class AdditiveBlendOp : UserBlendOp
	{
		...
		private sealed class AdditiveBlendOpWithOpacity : UserBlendOp
		{
			...
			public AdditiveBlendOpWithOpacity (int opacity) { if (this.opacity < 0 || this.opacity > 255) { throw new ArgumentOutOfRangeException (nameof (opacity)); } this.opacity = opacity; }
		}
	}
}
