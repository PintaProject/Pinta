...
partial class UserBlendOps
{
	...
	public sealed class ReflectBlendOp : UserBlendOp
	{
		...
		private sealed class ReflectBlendOpWithOpacity : UserBlendOp
		{
			...
			public ReflectBlendOpWithOpacity (int opacity) { if (this.opacity < 0 || this.opacity > 255) { throw new ArgumentOutOfRangeException (nameof (opacity)); } this.opacity = opacity; }
		}
	}
}
